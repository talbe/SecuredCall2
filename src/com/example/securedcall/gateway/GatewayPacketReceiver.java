...
public class GatewayPacketReceiver {
	 ...
	 */
	private static final int FULL_PACKET_SIZE = 39; 
	...
	public GatewayPacketReceiver(DatagramSocket cSocket) {
		...
		m_tblPrototypes.put(MessageType.SessionStart, new SessionStartPacket(0, (short)0));
		...
		m_tblPrototypes.put(MessageType.Tevet,
							new TevetRxPacket((short)0, (short)0, null));
	...
	public FromGatewayPacket receivePacket() throws IOException {
		...
		Globals.DbgLog(Constants.TRAFFIC_TAG, "GW-GetBuff: " + Utils.bytesToHex(arRawBuff));
